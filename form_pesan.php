                ...
                <div class="col-md-8">
                    <form id="formPemesanan" action="function/proses_pesan.php" method="post" class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="jumlah_hari" id="waktu_perjalanan" class="form-control" required>
                        </div>
                        <div class="col-md-12 pt-2">
                        ...
                        <div class="col-md-12 pt-2">
                            ...
                            <input type="text" name="jumlah_peserta" id="jumlah_peserta" class="form-control" required required>
                        </div>
                        <div class="col-md-12 pt-2">
                            <label for="inputPassword4" class="form-label">Harga Paket Perjalanan</label>
                            <input type="number" name="harga_paket" class="form-control" required id="hargaPaket" required readonly>
                        </div>
                        <div class="col-md-12 pt-2">
                            <label for="inputPemesan" class="form-label">Jumlah Tagihan</label>
                            <input type="text" name="total_tagihan" class="form-control" required id="jumlahTagihan" required readonly>
                        </div>

                        <div class="col-md-12 pt-2">
                            <button type="submit" name="pemesan" class="btn btn-primary">Simpan</button>
